        ...
        {selectedCourses.length > 0 && (
          <div className="px-4 py-3 border-t border-gray-200 dark:border-gray-700 space-y-1">
            <div className="flex items-center justify-between text-sm">
              <span className="text-gray-500 dark:text-gray-400">월 수강료</span>
            ...
            {totalMaterialCost > 0 && (
              <div className="flex items-center justify-between text-sm">
                <span className="text-gray-500 dark:text-gray-400">교재(재료)비</span>
                <span className="font-medium text-gray-800 dark:text-gray-200">
            ...
            <div className="flex items-center justify-between pt-1 border-t border-gray-100 dark:border-gray-700">
              <span className="text-sm font-semibold text-gray-700 dark:text-gray-200">월 합계</span>
